...
namespace TrainingTrackerAPI.Migrations
{
    ...
    [Migration("20251203105422_ChangedCalorieColumn")]
    partial class ChangedCalorieColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TrainingTrackerAPI.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrainingTrackerAPI.Models.Activity", b =>
                {
                    b.HasOne("TrainingTrackerAPI.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
